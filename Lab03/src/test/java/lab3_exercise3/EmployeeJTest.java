...
public class EmployeeJTest {
	...
	public void lab3_testDisplayRecord() {
		...
		assertEquals("James, Sid (1234): Director at £100000.0 (£27496.4 tax) and is eligible for bonus.",
				employee.toString());
	}
	...
	public void lab3_testDisplayRecordNew() {
		...
		// Test the string of of the correct format - this is precise.
		assertEquals("Kazamia, Stella (1234): Teaching Fellow at £150000.0 (£47496.4 tax) and is eligible for bonus.",
				employee.toString());
	}
	...
	public void lab3_testDisplayRecordNoBonus() {
		...
		// Test the string of of the correct format - this is precise.
		assertEquals("Bloggs, Joe (5678): Sales Person at £39999.0 (£5498.0 tax) and is not eligible for bonus.",
				employee.toString());
	}
	...
	public void lab3_testDisplayRecordNoBonusNew() {
		...
		// Test the string of of the correct format - this is precise.
		assertEquals("Bloggs, Joe (5678): Teacher at £17000.0 (£898.2 tax) and is not eligible for bonus.",
				employee.toString());
	}
	...
	public void lab3_testDisplayRecordNoBonus20And40() {
		...
		// Test the string of of the correct format - this is precise.
		assertEquals("Wonderland, Alice (5678): Teacher at £33000.0 (£4098.2 tax) and is not eligible for bonus.",
				employee.toString());
	}
